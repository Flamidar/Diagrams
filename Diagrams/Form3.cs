...
namespace Diagrams
{
    public partial class Form3 : Form //форма гистограммы
    {
        public Form3()
        {
            InitializeComponent();
        ...
        private void textBox_Y_KeyPress(object sender, KeyPressEventArgs e) //Проверка, позволяющая вводить в текстбокс только цифры, запятые, минусы и бэкспейс
        {
        ...
        {
            Form1 frm1 = new Form1(); // где Form1 название формы кусочно-линейной диаграммы
            frm1.Show();
        }
